            ...
            if user_df.empty:
                ...
                with st.spinner("Computing recommendations..."):
                    st.session_state["results"] = {
                        "items": get_items_recs(user_df, n),
                        "users": get_users_recs(user_df, n),
                        "overall": get_overall_recs(user_df, n),
